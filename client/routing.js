...
Router.route('/configure_session', function () {
  console.log("configure session");
  this.render("navbar", {to:"header"});
  this.render("configure_session", {to:"main"});
});
...
Router.route('/todo_list', function () {
  console.log("todo list");
  this.render("navbar", {to:"header"});
  this.render("todo_list", {to:"main"});
});


Router.route('/configure_players', function () {
  console.log("configure players");
  this.render("navbar", {to:"header"});
  this.render("configure_players", {to:"main"});
});
...
Router.route('/hands_list', function () {
  console.log("hands list");
  this.render("navbar", {to:"header"});
...
Router.route('/suits_list', function () {
  console.log("suits list");
  this.render("navbar", {to:"header"});
...
Router.route('/edit_player', function () {
  console.log("edit player");
  this.render("navbar", {to:"header"});
  this.render("edit_player", {to:"main"});
});
...
Router.route('/view_winner/:_id', function () {
  // the user they want to chat to has id equal to 
  // the id sent in after /chat/...
